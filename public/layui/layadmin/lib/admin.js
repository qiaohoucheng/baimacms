    ...
    function(e) {
        var a = layui.jquery,
            ...
            x = {
                ...
                sendAuthCode: function(e) {
                    ...
                    var i, t = e.seconds,
                        n = function(l) {
                            var s = a(e.elem);
                            t--,
                                t < 0 ? (s.removeClass(y).html("获取验证码"), t = e.seconds, clearInterval(i)) : s.addClass(y).html(t + "秒后重获"),
                ...
                sideFlexible: function(e) {
                    var i = u,
                        t = a("#" + h),
                        l = x.screen();
                    "spread" === e ? (t.removeClass(b).addClass(v), l < 2 ? i.addClass(f) : i.removeClass(f), i.removeClass(g)) : (t.removeClass(v).addClass(b), l < 2 ? i.removeClass(g) : i.addClass(g), i.removeClass(f)),
                ...
                initTheme: function(e) {
                    ...
                    var a = n.theme;
                    e = e || 0,
                    a.color[e] && (a.color[e].index = e, x.theme({
                        color: a.color[e]
                    }))
                },
                tabsPage: {},
            ...
            t.on("nav(layadmin-system-side-menu)",
                function(e) {
                    e.siblings(".layui-nav-child")[0] && u.hasClass(g) && (x.sideFlexible("spread"), layer.close(e.data("index"))),
                        x.tabsPage.type = "nav"
                }),
        ...
        o.on("click", z,
            function() {
                ...
                return x.tabsPage.type = "tab",
                    x.tabsPage.index = i,
                    "iframe" === e.attr("lay-attr") ? x.tabsBodyChange(i) : (F(e), void x.runResize())
            }),
