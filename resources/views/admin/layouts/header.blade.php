...
<ul class="layui-nav layui-layout-left">
    ...
    <span class="layui-nav-bar" style="left: 288px; top: 48px; width: 0px; opacity: 0;"></span></ul>
<ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
    ...
    <span class="layui-nav-bar" style="left: 140px; top: 48px; width: 0px; opacity: 0;"></span></ul>
