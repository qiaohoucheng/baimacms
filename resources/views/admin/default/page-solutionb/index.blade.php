            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        <form class="layui-form" action="{!!  '/page-solutionb' !!}"  method="POST" id="page_create">
                            ...
                            <table class="layui-table">
                                ...
                                <tr>
                                    <td  rowspan="7" scope="col" bgcolor="#F7F7F7" align="center">方案架构</td>
                                ...
                                <tr>
                                    <td  align="center">图片</td>
                                    <td>
                                        <button type="button" class="layui-btn upload-btn" name="C_23" id="C_23"  value="{{ $arr['C_23'] or '' }}">
                                            <i class="layui-icon"></i>上传文件</button>
                                    </td>
                                    <td><img src="{{ $arr['E_23'] or '' }}" id="E_23_img"><input type="hidden" name="E_23" id="E_23"  value="{{ $arr['E_23'] or '' }}"></td>
                                    <td align="center">img</td>
                                    <td><input type="text" class="layui-input"  name="U_23" id="U_23" value="{{ $arr['U_23'] or '' }}"  /></td>
                                </tr>
                                <tr>
                                    <td  align="center">图片标题</td>
                                    <td><input type="text" class="layui-input" name="C_24" id="C_24" value="{{ $arr['C_24'] or '' }}" /></td>
                                    <td><input type="text" class="layui-input" name="E_24" id="E_24" value="{{ $arr['E_24'] or '' }}" /></td>
                                    <td align="center">text</td>
                                    <td><input type="text" class="layui-input" name="U_24" id="U_24" value="{{ $arr['U_24'] or '' }}" /></td>
                                </tr>
                                <tr>
                                    <td  align="center">图片</td>
                                    <td>
                                        <button type="button" class="layui-btn upload-btn" name="C_25" id="C_25"  value="{{ $arr['C_25'] or '' }}">
                                            <i class="layui-icon"></i>上传文件</button>
                                    </td>
                                    <td><img src="{{ $arr['E_25'] or '' }}" id="E_25_img"><input type="hidden" name="E_25" id="E_25"  value="{{ $arr['E_25'] or '' }}"></td>
                                    <td align="center">img</td>
                                    <td><input type="text" class="layui-input"  name="U_25" id="U_25" value="{{ $arr['U_25'] or '' }}"  /></td>
                                </tr>
                                <tr>
                                    <td  align="center">图片标题</td>
                                    <td><input type="text" class="layui-input" name="C_26" id="C_26" value="{{ $arr['C_26'] or '' }}" /></td>
                                    <td><input type="text" class="layui-input" name="E_26" id="E_26" value="{{ $arr['E_26'] or '' }}" /></td>
                                    <td align="center">text</td>
                                    <td><input type="text" class="layui-input" name="U_26" id="U_26" value="{{ $arr['U_26'] or '' }}" /></td>
                                </tr>
                                <tr>
                                    <td  rowspan="2" scope="col" bgcolor="#F7F7F7" align="center">平台架构</td>
                                    <td  align="center">标题</td>
                                ...
                                <tr>
                                    <td  rowspan="6" scope="col" bgcolor="#F7F7F7" align="center">方案说明</td>
                                    <td  align="center">标题</td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="layui-input" name="C_41" id="C_41" value="{{ $arr['C_41'] or '' }}" /></td>
                                    <td><input type="text" class="layui-input" name="E_41" id="E_41" value="{{ $arr['E_41'] or '' }}" /></td>
                                    <td align="center">text</td>
