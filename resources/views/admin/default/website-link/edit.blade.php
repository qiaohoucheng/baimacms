            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        <form class="layui-form layui-form-pane" action="{!!  url('/website-link/'.$id) !!}" method="POST" id="banner_create">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" value="{{ $info['url'] }}" name="url" autocomplete="off"  lay-verify="required" placeholder="请输入轮播图链接" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
