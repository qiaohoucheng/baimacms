            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        <form class="layui-form layui-form-pane" action="{!!  '/website-cert' !!}" method="POST" id="banner_create">
                            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                            <input type="hidden" name="url" id="pic_id" value="0"/>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <select name="type" lay-filter="type" id="type">
                                        <option value=""></option>
                                        <option value="1">国家认证</option>
                                        <option value="2">专利证书</option>
                                    </select>
                                </div>
