            ...
            <div class="layui-col-md12">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body">
                        <form class="layui-form layui-form-pane" action="{!!  url('/website-cert/'.$id) !!}" method="POST" id="banner_create">
                            <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                            <input type="hidden" name="_method" value="PUT"/>
                            <input type="hidden" name="url" id="pic_id" value="{{ $info['url'] or 0 }}"/>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <select name="type" lay-filter="type" id="type">
                                        <option value=""></option>
                                        <option value="1" @if($info['type'] ==1) selected @endif>国家认证</option>
                                        <option value="2" @if($info['type'] ==2) selected @endif >专利证书</option>
                                    </select>
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <a class="layui-btn layui-btn-primary" href="{{ url('/website-cert') }}">返回</a>
                            </div>
                        </form>
        ...
        layui.use(['form','upload','jquery'], function(){
            ...
            form.on('submit(save)', function(data){
                ...
                $.post(thisform.attr('action'),data.field,function(data){
                    ...
                    if(data.code ==200){
                        setTimeout(function(){
                            window.location.href="/website-cert";
                        },1200)
                    }
                })
                return false;
