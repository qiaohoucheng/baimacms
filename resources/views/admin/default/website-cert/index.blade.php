                ...
                <div class="layui-card">
                    <div class="layui-card-header">
                        <div class="pull-right">
                            <a href="{{ url('/website-cert/create') }}" class="layui-btn layui-btn-sm" >添加证书</a>
                        </div>
                    </div>
                    <div class="layui-card-body">
                        ...
                        <script type="text/html" id="typebox">
                            @{{#  if(d.type == 1){ }}
                            <span class=" layui-badge layui-bg-gray">国家认证</span>
                            @{{#  }else{ }}
                            <span class=" layui-badge layui-bg-gray">专利证书</span>
                            @{{#  } }}
                        </script>
        ...
        layui.use(['table','form','layer'], function(){
            ...
            table.render({
                ...
                cols: [[
                    ...
                    ,{field:'type',align:'center',title:'分类', templet:'#typebox'}
                    ,{field:'url', width:200,title:'证书', templet:'#picbox'}
            ...
            table.on('tool(banner)', function(obj){
                var data = obj.data;
                if(obj.event === 'del'){
                    layer.confirm('您确定要删除这条友情链接吗？', function(index){
                ...
                if(obj.event ==='up'){
                    ...
                    if(id2 == undefined || id1 == undefined){
                        ...
                        $.post('website-cert/move',{'id1':id1,'id2':id2,'_token':token},function(data){
                            if(data.code==200){
                                $(".layui-laypage-btn").click();
                            }
                        });
